...
// Draw Whole Snake
function drawSnake() {
  //   we are drawing the snake form tail to  head is drawn last. It makes the head appear above all other drawings.
...
function eatFood() {
  ...
  if (x == fx && y == fy) {
    //     Increase score
    state.score++;
    //     Increases every time you eat food.
